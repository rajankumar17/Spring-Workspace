 ...
 * generated in the com.rajan.soaphandler package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerNameResponse_QNAME = new QName("http://soaphandler.rajan.com/", "getServerNameResponse");
    private final static QName _GetServerName_QNAME = new QName("http://soaphandler.rajan.com/", "getServerName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rajan.soaphandler
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaphandler.rajan.com/", name = "getServerNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaphandler.rajan.com/", name = "getServerName")
